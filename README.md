...
[![Version](https://img.shields.io/badge/Version-0.4.7.1-blue.svg)](config/static/base.json)
...
> 当前状态：S1-S10 重构完成（0.4.7.1）；任务清单见 `x.progress.md`，已知问题见 `y.problems.md`，版本路线见 `m.milestone.md`。
