...
[![Version](https://img.shields.io/badge/Version-0.4.7.7-blue.svg)](config/static/base.json)
...
> 当前状态：S1-S10 重构完成；两轮审计修复完成；UI 2.0 Fluent 重写完成（0.4.7.7，三态主题跟随系统）；任务清单见 `x.progress.md`，已知问题见 `y.problems.md`，版本路线见 `m.milestone.md`。
